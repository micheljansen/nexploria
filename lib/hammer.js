        ...
        transform : function(event)
        {
            if(options.transform) {
                ...
                if (_gesture === 'transform' ||
                    ...
                    var _distance_x = _pos.startCenter ? _pos.center.x - _pos.startCenter.x : 0;
                    var _distance_y = _pos.startCenter ? _pos.center.y - _pos.startCenter.y : 0;
                    _distance = Math.sqrt(_distance_x*_distance_x + _distance_y*_distance_y);
